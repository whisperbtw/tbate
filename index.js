...
class NovelScraper {
   ...
   <div class="chapter-buttons">
    ...
    generateHtml(chapterData) {
        ...
        return `<style>${style1}</style><body style="background-color: #222222; color: white; margin: 25px;"><div class="entry-title">${chapterData.title}</div><h2 style="text-align: center;">${chapterData.chapterName}</h2><p style="text-align: center;">Lançamento ${chapterData.date}</p>${chapterData.content}${div1}${script1}</body>`;
    }
